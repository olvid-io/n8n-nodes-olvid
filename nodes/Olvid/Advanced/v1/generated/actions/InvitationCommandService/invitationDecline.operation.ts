...
const displayOptions = {
  show: {
    ...
    operation: ['InvitationDecline'],
  },
};

export const invitationDeclineProperties = updateDisplayOptions(displayOptions, properties);

export async function invitationDecline(this: IExecuteFunctions, index: number, client: OlvidClient): Promise<INodeExecutionData[]> {
    const invitationId: bigint = BigInt(this.getNodeParameter('invitationId', index) as number);
    await client.stubs.invitationCommandStub.invitationDecline({invitationId});
