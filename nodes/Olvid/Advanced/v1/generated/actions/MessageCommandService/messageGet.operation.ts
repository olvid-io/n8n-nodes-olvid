...
export const messageGetProperties = updateDisplayOptions(displayOptions, properties);

export async function messageGet(this: IExecuteFunctions, index: number, client: OlvidClient): Promise<INodeExecutionData[]> {
    ...
    const response: commands.MessageGetResponse = await client.stubs.messageCommandStub.messageGet({messageId});
