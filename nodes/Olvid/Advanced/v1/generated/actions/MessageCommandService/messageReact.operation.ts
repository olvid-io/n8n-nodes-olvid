...
export const messageReactProperties = updateDisplayOptions(displayOptions, properties);

export async function messageReact(this: IExecuteFunctions, index: number, client: OlvidClient): Promise<INodeExecutionData[]> {
    ...
    await client.stubs.messageCommandStub.messageReact({messageId, reaction});
