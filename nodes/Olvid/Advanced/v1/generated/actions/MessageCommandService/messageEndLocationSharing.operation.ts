...
const displayOptions = {
  show: {
    ...
    operation: ['MessageEndLocationSharing'],
  },
};
...
export async function execute(this: IExecuteFunctions, index: number, client: OlvidClient): Promise<INodeExecutionData[]> {
    ...
    const response: commands.MessageEndLocationSharingResponse = await client.stubs.messageCommandStub.messageEndLocationSharing({messageId});
