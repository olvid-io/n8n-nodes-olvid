...
export const messageUpdateLocationSharingProperties = updateDisplayOptions(displayOptions, properties);

export async function messageUpdateLocationSharing(this: IExecuteFunctions, index: number, client: OlvidClient): Promise<INodeExecutionData[]> {
