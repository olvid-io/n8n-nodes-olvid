...
export const messageDeleteProperties = updateDisplayOptions(displayOptions, properties);

export async function messageDelete(this: IExecuteFunctions, index: number, client: OlvidClient): Promise<INodeExecutionData[]> {
    ...
    await client.stubs.messageCommandStub.messageDelete({messageId, deleteEverywhere});
