...
const displayOptions = {
  show: {
    ...
    operation: ['GroupNewReadOnlyGroup'],
  },
};
...
export async function groupNewReadOnlyGroup(this: IExecuteFunctions, index: number, client: OlvidClient): Promise<INodeExecutionData[]> {
    ...
    const response: commands.GroupNewReadOnlyGroupResponse = await client.stubs.groupCommandStub.groupNewReadOnlyGroup({name, description, adminContactIds, contactIds});
