...
export const groupListProperties = updateDisplayOptions(displayOptions, properties);

export async function groupList(this: IExecuteFunctions, index: number, client: OlvidClient): Promise<INodeExecutionData[]> {
