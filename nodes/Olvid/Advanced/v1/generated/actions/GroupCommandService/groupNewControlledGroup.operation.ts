...
const displayOptions = {
  show: {
    ...
    operation: ['GroupNewControlledGroup'],
  },
};

export const groupNewControlledGroupProperties = updateDisplayOptions(displayOptions, properties);

export async function groupNewControlledGroup(this: IExecuteFunctions, index: number, client: OlvidClient): Promise<INodeExecutionData[]> {
    ...
    const response: commands.GroupNewControlledGroupResponse = await client.stubs.groupCommandStub.groupNewControlledGroup({name, description, adminContactIds, contactIds});
