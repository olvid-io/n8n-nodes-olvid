...
export const groupGetProperties = updateDisplayOptions(displayOptions, properties);

export async function groupGet(this: IExecuteFunctions, index: number, client: OlvidClient): Promise<INodeExecutionData[]> {
