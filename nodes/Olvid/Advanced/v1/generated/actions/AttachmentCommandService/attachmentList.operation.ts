...
export const attachmentListProperties = updateDisplayOptions(displayOptions, properties);

export async function attachmentList(this: IExecuteFunctions, index: number, client: OlvidClient): Promise<INodeExecutionData[]> {
