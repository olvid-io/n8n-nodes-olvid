...
export const contactListProperties = updateDisplayOptions(displayOptions, properties);

export async function contactList(this: IExecuteFunctions, index: number, client: OlvidClient): Promise<INodeExecutionData[]> {
