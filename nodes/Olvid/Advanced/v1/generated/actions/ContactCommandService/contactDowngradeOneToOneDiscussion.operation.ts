...
const displayOptions = {
  show: {
    ...
    operation: ['ContactDowngradeOneToOneDiscussion'],
  },
};
...
export async function execute(this: IExecuteFunctions, index: number, client: OlvidClient): Promise<INodeExecutionData[]> {
    ...
    const response: commands.ContactDowngradeOneToOneDiscussionResponse = await client.stubs.contactCommandStub.contactDowngradeOneToOneDiscussion({contactId});
