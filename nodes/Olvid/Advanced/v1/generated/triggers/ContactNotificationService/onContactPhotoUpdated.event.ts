...
const displayOptions = {
  show: {
    updates: ['ContactPhotoUpdated'],
  },
};

export const contactPhotoUpdatedProperties = updateDisplayOptions(displayOptions, properties);
...
// contact.mockData
	...
	return client.stubs.contactNotificationStub.contactPhotoUpdated({count, filter, contactIds}, callback, () => {});
