...
const displayOptions = {
  show: {
    updates: ['ContactDeleted'],
  },
};

export const contactDeletedProperties = updateDisplayOptions(displayOptions, properties);
...
// contact.mockData
	...
	return client.stubs.contactNotificationStub.contactDeleted({count, filter, contactIds}, callback, () => {});
