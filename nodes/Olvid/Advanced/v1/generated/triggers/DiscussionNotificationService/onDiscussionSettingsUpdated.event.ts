...
const displayOptions = {
  show: {
    updates: ['DiscussionSettingsUpdated'],
  },
};

export const discussionSettingsUpdatedProperties = updateDisplayOptions(displayOptions, properties);
...
// previousSettings.mockData
	...
	return client.stubs.discussionNotificationStub.discussionSettingsUpdated({count, filter, discussionIds}, callback, () => {});
