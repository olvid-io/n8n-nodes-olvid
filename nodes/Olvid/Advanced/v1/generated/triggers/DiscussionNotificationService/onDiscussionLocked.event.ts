...
const displayOptions = {
  show: {
    updates: ['DiscussionLocked'],
  },
};

export const discussionLockedProperties = updateDisplayOptions(displayOptions, properties);
...
// discussion.mockData
	...
	return client.stubs.discussionNotificationStub.discussionLocked({count, filter, discussionIds}, callback, () => {});
