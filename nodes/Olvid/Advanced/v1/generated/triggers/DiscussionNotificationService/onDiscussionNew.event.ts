...
const displayOptions = {
  show: {
    updates: ['DiscussionNew'],
  },
};

export const discussionNewProperties = updateDisplayOptions(displayOptions, properties);
...
// discussion.mockData
	...
	return client.stubs.discussionNotificationStub.discussionNew({count, filter}, callback, () => {});
