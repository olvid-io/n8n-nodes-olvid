...
const displayOptions = {
  show: {
    updates: ['GroupDeleted'],
  },
};

export const groupDeletedProperties = updateDisplayOptions(displayOptions, properties);

export function groupDeleted(this: ITriggerFunctions, client: OlvidClient, onCallback?: Function, returnMockData: boolean = false): Function {
...
// group.mockData
	...
	const callback = (notification: notifications.GroupDeletedNotification) => {
	...
	return client.stubs.groupNotificationStub.groupDeleted({count, groupIds, groupFilter}, callback, () => {});
