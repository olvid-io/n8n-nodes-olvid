...
const properties: INodeProperties[] = [
  ...
  {
    displayName: 'PendingMemberFilter',
    ...
    options: [
      {
        displayName: 'PendingMemberFilter | IsContact',
        name: 'isContact',
        type: 'options',
      ...
      {
        displayName: 'PendingMemberFilter | HasDeclined',
        name: 'hasDeclined',
        type: 'options',
      ...
      {
        displayName: 'PendingMemberFilter | ContactId',
        name: 'contactId',
        type: 'number',
      ...
      {
        displayName: 'PendingMemberFilter | DisplayNameSearch',
        name: 'displayNameSearch',
        type: 'string',
      ...
      {
        displayName: 'PendingMemberFilter | Permissions',
        name: 'permissions',
        type: 'collection',
        default: {
        },
        options: [
          {
            displayName: 'PendingMemberFilter | Permissions| Admin',
            name: 'admin',
            type: 'options',
          ...
          {
            displayName: 'PendingMemberFilter | Permissions| SendMessage',
            name: 'sendMessage',
            type: 'options',
          ...
          {
            displayName: 'PendingMemberFilter | Permissions| RemoteDeleteAnything',
            name: 'remoteDeleteAnything',
            type: 'options',
          ...
          {
            displayName: 'PendingMemberFilter | Permissions| EditOrRemoteDeleteOwnMessages',
            name: 'editOrRemoteDeleteOwnMessages',
            type: 'options',
          ...
          {
            displayName: 'PendingMemberFilter | Permissions| ChangeSettings',
            name: 'changeSettings',
            type: 'options',
...
const displayOptions = {
  show: {
    updates: ['GroupPendingMemberAdded'],
  },
};

export const groupPendingMemberAddedProperties = updateDisplayOptions(displayOptions, properties);

export function groupPendingMemberAdded(this: ITriggerFunctions, client: OlvidClient, onCallback?: Function, returnMockData: boolean = false): Function {
    ...
    function getPendingMemberFilter(this: ITriggerFunctions, ): datatypes.PendingGroupMemberFilter | undefined {
        const itemPendingMemberFilter = this.getNodeParameter('pendingMemberFilter') as IDataObject | undefined;
        if (itemPendingMemberFilter === undefined) {
            return undefined;
        }
        function getIsContact(this: ITriggerFunctions, itemPendingGroupMemberFilter: IDataObject): datatypes.PendingGroupMemberFilter_Contact | undefined {
            const value: string | number | undefined = itemPendingGroupMemberFilter['isContact'] as string | number | undefined;
        ...
        const isContact: datatypes.PendingGroupMemberFilter_Contact | undefined = getIsContact.call(this, itemPendingMemberFilter);
        function getHasDeclined(this: ITriggerFunctions, itemPendingGroupMemberFilter: IDataObject): datatypes.PendingGroupMemberFilter_Declined | undefined {
            const value: string | number | undefined = itemPendingGroupMemberFilter['hasDeclined'] as string | number | undefined;
            if (value === undefined) {
                return undefined;
        ...
        const hasDeclined: datatypes.PendingGroupMemberFilter_Declined | undefined = getHasDeclined.call(this, itemPendingMemberFilter);
        const contactId: bigint | undefined = itemPendingMemberFilter['contactId'] ? BigInt(itemPendingMemberFilter['contactId'] as number) : undefined;
        const displayNameSearch: string | undefined = itemPendingMemberFilter['displayNameSearch'] ? itemPendingMemberFilter['displayNameSearch'] as string : undefined;
        function getPermissions(this: ITriggerFunctions, itemPendingGroupMemberFilter: IDataObject): datatypes.GroupPermissionFilter | undefined {
            const itemPermissions = itemPendingGroupMemberFilter['permissions'] as IDataObject | undefined;
            if (itemPermissions === undefined) {
                return undefined;
        ...
        const permissions: datatypes.GroupPermissionFilter | undefined = getPermissions.call(this, itemPendingMemberFilter);
        return create(datatypes.PendingGroupMemberFilterSchema, {
            isContact,
            hasDeclined,
            contactId,
    ...
    const pendingMemberFilter: datatypes.PendingGroupMemberFilter | undefined = getPendingMemberFilter.call(this, );
...
// pendingMember.mockData
	...
	const callback = (notification: notifications.GroupPendingMemberAddedNotification) => {
	...
	return client.stubs.groupNotificationStub.groupPendingMemberAdded({count, groupIds, groupFilter, pendingMemberFilter}, callback, () => {});
