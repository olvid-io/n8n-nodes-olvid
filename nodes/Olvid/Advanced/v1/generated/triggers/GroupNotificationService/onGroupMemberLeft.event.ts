...
const displayOptions = {
  show: {
    updates: ['GroupMemberLeft'],
  },
};

export const groupMemberLeftProperties = updateDisplayOptions(displayOptions, properties);
...
// member.mockData
	...
	return client.stubs.groupNotificationStub.groupMemberLeft({count, groupIds, groupFilter, memberFilter}, callback, () => {});
