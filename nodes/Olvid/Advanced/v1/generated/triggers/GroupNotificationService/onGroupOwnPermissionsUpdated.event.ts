...
const properties: INodeProperties[] = [
  ...
  },
  {
    ...
    options: [
      {
        displayName: 'PermissionsFilter | Admin',
        name: 'admin',
        type: 'options',
      ...
      {
        displayName: 'PermissionsFilter | SendMessage',
        name: 'sendMessage',
        type: 'options',
      ...
      {
        displayName: 'PermissionsFilter | RemoteDeleteAnything',
        name: 'remoteDeleteAnything',
        type: 'options',
      ...
      {
        displayName: 'PermissionsFilter | EditOrRemoteDeleteOwnMessages',
        name: 'editOrRemoteDeleteOwnMessages',
        type: 'options',
      ...
      {
        displayName: 'PermissionsFilter | ChangeSettings',
        name: 'changeSettings',
        type: 'options',
  ...
  },
  {
    ...
    options: [
      {
        displayName: 'PreviousPermissionsFilter | Admin',
        name: 'admin',
        type: 'options',
      ...
      {
        displayName: 'PreviousPermissionsFilter | SendMessage',
        name: 'sendMessage',
        type: 'options',
      ...
      {
        displayName: 'PreviousPermissionsFilter | RemoteDeleteAnything',
        name: 'remoteDeleteAnything',
        type: 'options',
      ...
      {
        displayName: 'PreviousPermissionsFilter | EditOrRemoteDeleteOwnMessages',
        name: 'editOrRemoteDeleteOwnMessages',
        type: 'options',
      ...
      {
        displayName: 'PreviousPermissionsFilter | ChangeSettings',
        name: 'changeSettings',
        type: 'options',
...
const displayOptions = {
  show: {
    updates: ['GroupOwnPermissionsUpdated'],
  },
};

export const groupOwnPermissionsUpdatedProperties = updateDisplayOptions(displayOptions, properties);
...
export function groupOwnPermissionsUpdated(this: ITriggerFunctions, client: OlvidClient, onCallback?: Function, returnMockData: boolean = false): Function {
    ...
    function getPermissionsFilter(this: ITriggerFunctions, ): datatypes.GroupPermissionFilter | undefined {
        const itemPermissionsFilter = this.getNodeParameter('permissionsFilter') as IDataObject | undefined;
        if (itemPermissionsFilter === undefined) {
            return undefined;
        }
        function getAdmin(this: ITriggerFunctions, itemGroupPermissionFilter: IDataObject): datatypes.GroupPermissionFilter_Admin | undefined {
            const value: string | number | undefined = itemGroupPermissionFilter['admin'] as string | number | undefined;
        ...
        const admin: datatypes.GroupPermissionFilter_Admin | undefined = getAdmin.call(this, itemPermissionsFilter);
        function getSendMessage(this: ITriggerFunctions, itemGroupPermissionFilter: IDataObject): datatypes.GroupPermissionFilter_SendMessage | undefined {
            const value: string | number | undefined = itemGroupPermissionFilter['sendMessage'] as string | number | undefined;
            if (value === undefined) {
                return undefined;
        ...
        const sendMessage: datatypes.GroupPermissionFilter_SendMessage | undefined = getSendMessage.call(this, itemPermissionsFilter);
        function getRemoteDeleteAnything(this: ITriggerFunctions, itemGroupPermissionFilter: IDataObject): datatypes.GroupPermissionFilter_RemoteDeleteAnything | undefined {
            const value: string | number | undefined = itemGroupPermissionFilter['remoteDeleteAnything'] as string | number | undefined;
            if (value === undefined) {
                return undefined;
        ...
        const remoteDeleteAnything: datatypes.GroupPermissionFilter_RemoteDeleteAnything | undefined = getRemoteDeleteAnything.call(this, itemPermissionsFilter);
        function getEditOrRemoteDeleteOwnMessages(this: ITriggerFunctions, itemGroupPermissionFilter: IDataObject): datatypes.GroupPermissionFilter_EditOrRemoteDeleteOwnMessage | undefined {
            const value: string | number | undefined = itemGroupPermissionFilter['editOrRemoteDeleteOwnMessages'] as string | number | undefined;
            if (value === undefined) {
                return undefined;
        ...
        const editOrRemoteDeleteOwnMessages: datatypes.GroupPermissionFilter_EditOrRemoteDeleteOwnMessage | undefined = getEditOrRemoteDeleteOwnMessages.call(this, itemPermissionsFilter);
        function getChangeSettings(this: ITriggerFunctions, itemGroupPermissionFilter: IDataObject): datatypes.GroupPermissionFilter_ChangeSettings | undefined {
            const value: string | number | undefined = itemGroupPermissionFilter['changeSettings'] as string | number | undefined;
            if (value === undefined) {
                return undefined;
        ...
        const changeSettings: datatypes.GroupPermissionFilter_ChangeSettings | undefined = getChangeSettings.call(this, itemPermissionsFilter);
        return new datatypes.GroupPermissionFilter({
            admin,
            sendMessage,
            remoteDeleteAnything,
    ...
    const permissionsFilter: datatypes.GroupPermissionFilter | undefined = getPermissionsFilter.call(this, );
    function getPreviousPermissionsFilter(this: ITriggerFunctions, ): datatypes.GroupPermissionFilter | undefined {
        const itemPreviousPermissionsFilter = this.getNodeParameter('previousPermissionsFilter') as IDataObject | undefined;
        if (itemPreviousPermissionsFilter === undefined) {
            return undefined;
        }
        function getAdmin(this: ITriggerFunctions, itemGroupPermissionFilter: IDataObject): datatypes.GroupPermissionFilter_Admin | undefined {
            const value: string | number | undefined = itemGroupPermissionFilter['admin'] as string | number | undefined;
        ...
        const admin: datatypes.GroupPermissionFilter_Admin | undefined = getAdmin.call(this, itemPreviousPermissionsFilter);
        function getSendMessage(this: ITriggerFunctions, itemGroupPermissionFilter: IDataObject): datatypes.GroupPermissionFilter_SendMessage | undefined {
            const value: string | number | undefined = itemGroupPermissionFilter['sendMessage'] as string | number | undefined;
            if (value === undefined) {
                return undefined;
        ...
        const sendMessage: datatypes.GroupPermissionFilter_SendMessage | undefined = getSendMessage.call(this, itemPreviousPermissionsFilter);
        function getRemoteDeleteAnything(this: ITriggerFunctions, itemGroupPermissionFilter: IDataObject): datatypes.GroupPermissionFilter_RemoteDeleteAnything | undefined {
            const value: string | number | undefined = itemGroupPermissionFilter['remoteDeleteAnything'] as string | number | undefined;
            if (value === undefined) {
                return undefined;
        ...
        const remoteDeleteAnything: datatypes.GroupPermissionFilter_RemoteDeleteAnything | undefined = getRemoteDeleteAnything.call(this, itemPreviousPermissionsFilter);
        function getEditOrRemoteDeleteOwnMessages(this: ITriggerFunctions, itemGroupPermissionFilter: IDataObject): datatypes.GroupPermissionFilter_EditOrRemoteDeleteOwnMessage | undefined {
            const value: string | number | undefined = itemGroupPermissionFilter['editOrRemoteDeleteOwnMessages'] as string | number | undefined;
            if (value === undefined) {
                return undefined;
        ...
        const editOrRemoteDeleteOwnMessages: datatypes.GroupPermissionFilter_EditOrRemoteDeleteOwnMessage | undefined = getEditOrRemoteDeleteOwnMessages.call(this, itemPreviousPermissionsFilter);
        function getChangeSettings(this: ITriggerFunctions, itemGroupPermissionFilter: IDataObject): datatypes.GroupPermissionFilter_ChangeSettings | undefined {
            const value: string | number | undefined = itemGroupPermissionFilter['changeSettings'] as string | number | undefined;
            if (value === undefined) {
                return undefined;
        ...
        const changeSettings: datatypes.GroupPermissionFilter_ChangeSettings | undefined = getChangeSettings.call(this, itemPreviousPermissionsFilter);
        return new datatypes.GroupPermissionFilter({
            admin,
            sendMessage,
            remoteDeleteAnything,
    ...
    const previousPermissionsFilter: datatypes.GroupPermissionFilter | undefined = getPreviousPermissionsFilter.call(this, );
...
// previousPermissions.mockData
	...
	return client.stubs.groupNotificationStub.groupOwnPermissionsUpdated({count, groupIds, groupFilter, permissionsFilter, previousPermissionsFilter}, callback, () => {});
