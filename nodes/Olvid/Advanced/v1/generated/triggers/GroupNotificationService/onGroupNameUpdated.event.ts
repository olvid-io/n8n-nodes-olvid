...
const properties: INodeProperties[] = [
  ...
  {
    displayName: 'PreviousNameSearch',
    name: 'previousNameSearch',
    type: 'string',
    required: false,
...
const displayOptions = {
  show: {
    updates: ['GroupNameUpdated'],
  },
};

export const groupNameUpdatedProperties = updateDisplayOptions(displayOptions, properties);
...
export function groupNameUpdated(this: ITriggerFunctions, client: OlvidClient, onCallback?: Function, returnMockData: boolean = false): Function {
    ...
    const previousNameSearch: string | undefined = this.getNodeParameter('previousNameSearch') ? this.getNodeParameter('previousNameSearch') as string : undefined;
...
// previousName.mockData
	...
	return client.stubs.groupNotificationStub.groupNameUpdated({count, groupIds, groupFilter, previousNameSearch}, callback, () => {});
