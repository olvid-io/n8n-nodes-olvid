...
const displayOptions = {
  show: {
    updates: ['GroupPendingMemberRemoved'],
  },
};

export const groupPendingMemberRemovedProperties = updateDisplayOptions(displayOptions, properties);
...
// pendingMember.mockData
	...
	return client.stubs.groupNotificationStub.groupPendingMemberRemoved({count, groupIds, groupFilter, pendingMemberFilter}, callback, () => {});
