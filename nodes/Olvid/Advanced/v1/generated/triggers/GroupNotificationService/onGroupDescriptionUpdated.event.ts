...
const properties: INodeProperties[] = [
  ...
  {
    displayName: 'PreviousDescriptionSearch',
    name: 'previousDescriptionSearch',
    type: 'string',
    required: false,
...
const displayOptions = {
  show: {
    updates: ['GroupDescriptionUpdated'],
  },
};

export const groupDescriptionUpdatedProperties = updateDisplayOptions(displayOptions, properties);

export function groupDescriptionUpdated(this: ITriggerFunctions, client: OlvidClient, onCallback?: Function, returnMockData: boolean = false): Function {
