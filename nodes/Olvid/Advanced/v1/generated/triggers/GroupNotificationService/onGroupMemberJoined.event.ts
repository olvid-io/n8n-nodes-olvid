...
const displayOptions = {
  show: {
    updates: ['GroupMemberJoined'],
  },
};

export const groupMemberJoinedProperties = updateDisplayOptions(displayOptions, properties);
...
// member.mockData
	...
	return client.stubs.groupNotificationStub.groupMemberJoined({count, groupIds, groupFilter, memberFilter}, callback, () => {});
