...
const properties: INodeProperties[] = [
  ...
  },
  {
    ...
    options: [
      {
        displayName: 'MemberFilter | ContactId',
        name: 'contactId',
        type: 'number',
      ...
      {
        displayName: 'MemberFilter | Permissions',
        name: 'permissions',
        type: 'collection',
        default: {
        },
        options: [
          {
            displayName: 'MemberFilter | Permissions| Admin',
            name: 'admin',
            type: 'options',
          ...
          {
            displayName: 'MemberFilter | Permissions| SendMessage',
            name: 'sendMessage',
            type: 'options',
          ...
          {
            displayName: 'MemberFilter | Permissions| RemoteDeleteAnything',
            name: 'remoteDeleteAnything',
            type: 'options',
          ...
          {
            displayName: 'MemberFilter | Permissions| EditOrRemoteDeleteOwnMessages',
            name: 'editOrRemoteDeleteOwnMessages',
            type: 'options',
          ...
          {
            displayName: 'MemberFilter | Permissions| ChangeSettings',
            name: 'changeSettings',
            type: 'options',
  ...
  {
    displayName: 'PreviousPermissionFilter',
    name: 'previousPermissionFilter',
    type: 'collection',
    default: {
    },
    options: [
      {
        displayName: 'PreviousPermissionFilter | ContactId',
        name: 'contactId',
        type: 'number',
      ...
      {
        displayName: 'PreviousPermissionFilter | Permissions',
        name: 'permissions',
        type: 'collection',
        default: {
        },
        options: [
          {
            displayName: 'PreviousPermissionFilter | Permissions| Admin',
            name: 'admin',
            type: 'options',
          ...
          {
            displayName: 'PreviousPermissionFilter | Permissions| SendMessage',
            name: 'sendMessage',
            type: 'options',
          ...
          {
            displayName: 'PreviousPermissionFilter | Permissions| RemoteDeleteAnything',
            name: 'remoteDeleteAnything',
            type: 'options',
          ...
          {
            displayName: 'PreviousPermissionFilter | Permissions| EditOrRemoteDeleteOwnMessages',
            name: 'editOrRemoteDeleteOwnMessages',
            type: 'options',
          ...
          {
            displayName: 'PreviousPermissionFilter | Permissions| ChangeSettings',
            name: 'changeSettings',
            type: 'options',
...
const displayOptions = {
  show: {
    updates: ['GroupMemberPermissionsUpdated'],
  },
};

export const groupMemberPermissionsUpdatedProperties = updateDisplayOptions(displayOptions, properties);

export function groupMemberPermissionsUpdated(this: ITriggerFunctions, client: OlvidClient, onCallback?: Function, returnMockData: boolean = false): Function {
    ...
    function getMemberFilter(this: ITriggerFunctions, ): datatypes.GroupMemberFilter | undefined {
        const itemMemberFilter = this.getNodeParameter('memberFilter') as IDataObject | undefined;
        if (itemMemberFilter === undefined) {
            return undefined;
        }
        const contactId: bigint | undefined = itemMemberFilter['contactId'] ? BigInt(itemMemberFilter['contactId'] as number) : undefined;
        function getPermissions(this: ITriggerFunctions, itemGroupMemberFilter: IDataObject): datatypes.GroupPermissionFilter | undefined {
            const itemPermissions = itemGroupMemberFilter['permissions'] as IDataObject | undefined;
            if (itemPermissions === undefined) {
                return undefined;
        ...
        const permissions: datatypes.GroupPermissionFilter | undefined = getPermissions.call(this, itemMemberFilter);
        return create(datatypes.GroupMemberFilterSchema, {
            contactId,
            permissions,
        });
    }
    const memberFilter: datatypes.GroupMemberFilter | undefined = getMemberFilter.call(this, );
    function getPreviousPermissionFilter(this: ITriggerFunctions, ): datatypes.GroupMemberFilter | undefined {
        const itemPreviousPermissionFilter = this.getNodeParameter('previousPermissionFilter') as IDataObject | undefined;
        if (itemPreviousPermissionFilter === undefined) {
            return undefined;
        }
        const contactId: bigint | undefined = itemPreviousPermissionFilter['contactId'] ? BigInt(itemPreviousPermissionFilter['contactId'] as number) : undefined;
        function getPermissions(this: ITriggerFunctions, itemGroupMemberFilter: IDataObject): datatypes.GroupPermissionFilter | undefined {
            const itemPermissions = itemGroupMemberFilter['permissions'] as IDataObject | undefined;
            if (itemPermissions === undefined) {
                return undefined;
        ...
        const permissions: datatypes.GroupPermissionFilter | undefined = getPermissions.call(this, itemPreviousPermissionFilter);
        return create(datatypes.GroupMemberFilterSchema, {
            contactId,
            permissions,
        });
    }
    const previousPermissionFilter: datatypes.GroupMemberFilter | undefined = getPreviousPermissionFilter.call(this, );
