...
const displayOptions = {
  show: {
    updates: ['GroupPhotoUpdated'],
  },
};

export const groupPhotoUpdatedProperties = updateDisplayOptions(displayOptions, properties);

export function groupPhotoUpdated(this: ITriggerFunctions, client: OlvidClient, onCallback?: Function, returnMockData: boolean = false): Function {
...
// group.mockData
	...
	const callback = (notification: notifications.GroupPhotoUpdatedNotification) => {
	...
	return client.stubs.groupNotificationStub.groupPhotoUpdated({count, groupIds, groupFilter}, callback, () => {});
