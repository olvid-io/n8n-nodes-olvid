...
const properties: INodeProperties[] = [
  ...
  {
    displayName: 'AttachmentIds - List',
    name: 'attachmentIdsList',
    type: 'fixedCollection',
    typeOptions: {
      multipleValues: true,
    },
        ...
        values: [
          {
            ...
            options: [
              {
                displayName: 'AttachmentIds | Type',
                name: 'type',
                type: 'options',
...
const displayOptions = {
  show: {
    updates: ['AttachmentUploaded'],
  },
};

export const attachmentUploadedProperties = updateDisplayOptions(displayOptions, properties);
...
export function attachmentUploaded(this: ITriggerFunctions, client: OlvidClient, onCallback?: Function, returnMockData: boolean = false): Function {
    ...
    function getMessageIds(this: ITriggerFunctions, ): datatypes.MessageId[] {
        function getMessageIds(this: ITriggerFunctions, itemSubscribeToAttachmentUploadedNotification: IDataObject): datatypes.MessageId {
            const itemMessageIds = itemSubscribeToAttachmentUploadedNotification['messageIds'] as IDataObject;
    ...
    function getAttachmentIds(this: ITriggerFunctions, ): datatypes.AttachmentId[] {
        function getAttachmentIds(this: ITriggerFunctions, itemSubscribeToAttachmentUploadedNotification: IDataObject): datatypes.AttachmentId {
            const itemAttachmentIds = itemSubscribeToAttachmentUploadedNotification['attachmentIds'] as IDataObject;
            function getType(this: ITriggerFunctions, itemAttachmentId: IDataObject): datatypes.AttachmentId_Type {
        ...
        const attachmentIdsCollectionParent: IDataObject | undefined = this.getNodeParameter('attachmentIdsList') as IDataObject | undefined;
        if (attachmentIdsCollectionParent === undefined) {
            return [];
        }
        const attachmentIdsCollection: IDataObject[] | undefined = attachmentIdsCollectionParent['collection'] as IDataObject[] | undefined;
        if (attachmentIdsCollection === undefined) {
            return [];
        }
        const attachmentIdsList: datatypes.AttachmentId[] = [];
        for (const itemAttachmentIds of attachmentIdsCollection) {
            const attachmentIds: datatypes.AttachmentId = getAttachmentIds.call(this, itemAttachmentIds);
            attachmentIdsList.push(attachmentIds);
        }
        return attachmentIdsList;
    }
    const attachmentIds: datatypes.AttachmentId[] = getAttachmentIds.call(this, );
...
// attachment.mockData
	...
	return client.stubs.attachmentNotificationStub.attachmentUploaded({count, filter, messageIds, attachmentIds}, callback, () => {});
