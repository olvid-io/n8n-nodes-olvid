...
const displayOptions = {
  show: {
    updates: ['InvitationDeleted'],
  },
};

export const invitationDeletedProperties = updateDisplayOptions(displayOptions, properties);
...
// invitation.mockData
	...
	return client.stubs.invitationNotificationStub.invitationDeleted({count, filter, invitationIds}, callback, () => {});
