...
const displayOptions = {
  show: {
    updates: ['InvitationSent'],
  },
};

export const invitationSentProperties = updateDisplayOptions(displayOptions, properties);

export function invitationSent(this: ITriggerFunctions, client: OlvidClient, onCallback?: Function, returnMockData: boolean = false): Function {
...
// invitation.mockData
	...
	const callback = (notification: notifications.InvitationSentNotification) => {
	...
	return client.stubs.invitationNotificationStub.invitationSent({count, filter}, callback, () => {});
