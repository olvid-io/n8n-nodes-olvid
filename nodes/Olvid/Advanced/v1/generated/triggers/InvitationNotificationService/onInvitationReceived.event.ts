...
const displayOptions = {
  show: {
    updates: ['InvitationReceived'],
  },
};

export const invitationReceivedProperties = updateDisplayOptions(displayOptions, properties);
...
// invitation.mockData
	...
	return client.stubs.invitationNotificationStub.invitationReceived({count, filter}, callback, () => {});
