...
export const callBusyProperties = updateDisplayOptions(displayOptions, properties);

export function callBusy(this: ITriggerFunctions, client: OlvidClient, onCallback?: Function, returnMockData: boolean = false): Function {
...
// participantId.mockData
	...
	const callback = (notification: notifications.CallBusyNotification) => {
	...
	return client.stubs.callNotificationStub.callBusy({count}, callback, () => {});
