...
const displayOptions = {
  show: {
    updates: ['CallDeclined'],
  },
};

export const callDeclinedProperties = updateDisplayOptions(displayOptions, properties);
...
// participantId.mockData
	...
	return client.stubs.callNotificationStub.callDeclined({count}, callback, () => {});
