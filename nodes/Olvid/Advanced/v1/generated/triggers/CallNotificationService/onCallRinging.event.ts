...
export const callRingingProperties = updateDisplayOptions(displayOptions, properties);

export function callRinging(this: ITriggerFunctions, client: OlvidClient, onCallback?: Function, returnMockData: boolean = false): Function {
...
// participantId.mockData
	...
	const callback = (notification: notifications.CallRingingNotification) => {
	...
	return client.stubs.callNotificationStub.callRinging({count}, callback, () => {});
