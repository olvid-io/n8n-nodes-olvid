...
const displayOptions = {
  show: {
    updates: ['MessageDelivered'],
  },
};

export const messageDeliveredProperties = updateDisplayOptions(displayOptions, properties);

export function messageDelivered(this: ITriggerFunctions, client: OlvidClient, onCallback?: Function, returnMockData: boolean = false): Function {
    ...
    function getMessageIds(this: ITriggerFunctions, ): datatypes.MessageId[] {
        function getMessageIds(this: ITriggerFunctions, itemSubscribeToMessageDeliveredNotification: IDataObject): datatypes.MessageId {
            const itemMessageIds = itemSubscribeToMessageDeliveredNotification['messageIds'] as IDataObject;
...
// message.mockData
	...
	const callback = (notification: notifications.MessageDeliveredNotification) => {
	...
	return client.stubs.messageNotificationStub.messageDelivered({count, messageIds, filter}, callback, () => {});
