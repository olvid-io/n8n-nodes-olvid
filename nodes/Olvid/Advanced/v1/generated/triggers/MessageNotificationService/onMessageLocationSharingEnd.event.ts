...
const displayOptions = {
  show: {
    updates: ['MessageLocationSharingEnd'],
  },
};

export const messageLocationSharingEndProperties = updateDisplayOptions(displayOptions, properties);

export function messageLocationSharingEnd(this: ITriggerFunctions, client: OlvidClient, onCallback?: Function, returnMockData: boolean = false): Function {
    ...
    function getMessageIds(this: ITriggerFunctions, ): datatypes.MessageId[] {
        function getMessageIds(this: ITriggerFunctions, itemSubscribeToMessageLocationSharingEndNotification: IDataObject): datatypes.MessageId {
            const itemMessageIds = itemSubscribeToMessageLocationSharingEndNotification['messageIds'] as IDataObject;
...
// message.mockData
	...
	const callback = (notification: notifications.MessageLocationSharingEndNotification) => {
	...
	return client.stubs.messageNotificationStub.messageLocationSharingEnd({count, messageIds, filter}, callback, () => {});
