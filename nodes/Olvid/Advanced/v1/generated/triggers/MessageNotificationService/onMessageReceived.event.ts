...
export const messageReceivedProperties = updateDisplayOptions(displayOptions, properties);
...
// message.mockData
	...
	return client.stubs.messageNotificationStub.messageReceived({count, filter}, callback, () => {});
