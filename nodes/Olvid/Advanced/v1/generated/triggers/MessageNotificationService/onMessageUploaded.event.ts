...
const displayOptions = {
  show: {
    updates: ['MessageUploaded'],
  },
};

export const messageUploadedProperties = updateDisplayOptions(displayOptions, properties);

export function messageUploaded(this: ITriggerFunctions, client: OlvidClient, onCallback?: Function, returnMockData: boolean = false): Function {
    ...
    function getMessageIds(this: ITriggerFunctions, ): datatypes.MessageId[] {
        function getMessageIds(this: ITriggerFunctions, itemSubscribeToMessageUploadedNotification: IDataObject): datatypes.MessageId {
            const itemMessageIds = itemSubscribeToMessageUploadedNotification['messageIds'] as IDataObject;
...
// message.mockData
	...
	const callback = (notification: notifications.MessageUploadedNotification) => {
	...
	return client.stubs.messageNotificationStub.messageUploaded({count, messageIds, filter}, callback, () => {});
