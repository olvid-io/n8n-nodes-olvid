...
const displayOptions = {
  show: {
    updates: ['MessageReactionAdded'],
  },
};

export const messageReactionAddedProperties = updateDisplayOptions(displayOptions, properties);
...
export function messageReactionAdded(this: ITriggerFunctions, client: OlvidClient, onCallback?: Function, returnMockData: boolean = false): Function {
    ...
    function getMessageIds(this: ITriggerFunctions, ): datatypes.MessageId[] {
        function getMessageIds(this: ITriggerFunctions, itemSubscribeToMessageReactionAddedNotification: IDataObject): datatypes.MessageId {
            const itemMessageIds = itemSubscribeToMessageReactionAddedNotification['messageIds'] as IDataObject;
...
// reaction.mockData
	...
	return client.stubs.messageNotificationStub.messageReactionAdded({count, messageIds, filter, reactionFilter}, callback, () => {});
