...
const displayOptions = {
  show: {
    updates: ['MessageLocationSharingStart'],
  },
};

export const messageLocationSharingStartProperties = updateDisplayOptions(displayOptions, properties);

export function messageLocationSharingStart(this: ITriggerFunctions, client: OlvidClient, onCallback?: Function, returnMockData: boolean = false): Function {
...
// message.mockData
	...
	const callback = (notification: notifications.MessageLocationSharingStartNotification) => {
	...
	return client.stubs.messageNotificationStub.messageLocationSharingStart({count, filter}, callback, () => {});
