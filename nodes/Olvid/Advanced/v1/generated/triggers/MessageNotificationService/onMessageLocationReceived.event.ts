...
const displayOptions = {
  show: {
    updates: ['MessageLocationReceived'],
  },
};

export const messageLocationReceivedProperties = updateDisplayOptions(displayOptions, properties);

export function messageLocationReceived(this: ITriggerFunctions, client: OlvidClient, onCallback?: Function, returnMockData: boolean = false): Function {
...
// message.mockData
	...
	const callback = (notification: notifications.MessageLocationReceivedNotification) => {
	...
	return client.stubs.messageNotificationStub.messageLocationReceived({count, filter}, callback, () => {});
