...
const displayOptions = {
  show: {
    updates: ['MessageReactionRemoved'],
  },
};

export const messageReactionRemovedProperties = updateDisplayOptions(displayOptions, properties);

export function messageReactionRemoved(this: ITriggerFunctions, client: OlvidClient, onCallback?: Function, returnMockData: boolean = false): Function {
    ...
    function getMessageIds(this: ITriggerFunctions, ): datatypes.MessageId[] {
        function getMessageIds(this: ITriggerFunctions, itemSubscribeToMessageReactionRemovedNotification: IDataObject): datatypes.MessageId {
            const itemMessageIds = itemSubscribeToMessageReactionRemovedNotification['messageIds'] as IDataObject;
...
// reaction.mockData
	...
	const callback = (notification: notifications.MessageReactionRemovedNotification) => {
	...
	return client.stubs.messageNotificationStub.messageReactionRemoved({count, messageIds, filter, reactionFilter}, callback, () => {});
