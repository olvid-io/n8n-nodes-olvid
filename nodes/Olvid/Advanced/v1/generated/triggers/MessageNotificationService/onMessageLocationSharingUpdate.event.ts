...
const displayOptions = {
  show: {
    updates: ['MessageLocationSharingUpdate'],
  },
};

export const messageLocationSharingUpdateProperties = updateDisplayOptions(displayOptions, properties);
...
export function messageLocationSharingUpdate(this: ITriggerFunctions, client: OlvidClient, onCallback?: Function, returnMockData: boolean = false): Function {
    ...
    function getMessageIds(this: ITriggerFunctions, ): datatypes.MessageId[] {
        function getMessageIds(this: ITriggerFunctions, itemSubscribeToMessageLocationSharingUpdateNotification: IDataObject): datatypes.MessageId {
            const itemMessageIds = itemSubscribeToMessageLocationSharingUpdateNotification['messageIds'] as IDataObject;
    ...
    function getFilter(this: ITriggerFunctions, ): datatypes.MessageFilter | undefined {
