...
const displayOptions = {
  show: {
    updates: ['MessageLocationSent'],
  },
};

export const messageLocationSentProperties = updateDisplayOptions(displayOptions, properties);

export function messageLocationSent(this: ITriggerFunctions, client: OlvidClient, onCallback?: Function, returnMockData: boolean = false): Function {
...
// message.mockData
	...
	const callback = (notification: notifications.MessageLocationSentNotification) => {
	...
	return client.stubs.messageNotificationStub.messageLocationSent({count, filter}, callback, () => {});
