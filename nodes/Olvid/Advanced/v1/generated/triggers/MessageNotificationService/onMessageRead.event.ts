...
export const messageReadProperties = updateDisplayOptions(displayOptions, properties);
...
export function messageRead(this: ITriggerFunctions, client: OlvidClient, onCallback?: Function, returnMockData: boolean = false): Function {
    ...
    function getMessageIds(this: ITriggerFunctions, ): datatypes.MessageId[] {
        function getMessageIds(this: ITriggerFunctions, itemSubscribeToMessageReadNotification: IDataObject): datatypes.MessageId {
            const itemMessageIds = itemSubscribeToMessageReadNotification['messageIds'] as IDataObject;
...
// message.mockData
	...
	return client.stubs.messageNotificationStub.messageRead({count, messageIds, filter}, callback, () => {});
