...
export const messageSentProperties = updateDisplayOptions(displayOptions, properties);

export function messageSent(this: ITriggerFunctions, client: OlvidClient, onCallback?: Function, returnMockData: boolean = false): Function {
...
// message.mockData
	...
	const callback = (notification: notifications.MessageSentNotification) => {
	...
	return client.stubs.messageNotificationStub.messageSent({count, filter}, callback, () => {});
