...
const displayOptions = {
  show: {
    updates: ['MessageDeleted'],
  },
};

export const messageDeletedProperties = updateDisplayOptions(displayOptions, properties);

export function messageDeleted(this: ITriggerFunctions, client: OlvidClient, onCallback?: Function, returnMockData: boolean = false): Function {
    ...
    function getMessageIds(this: ITriggerFunctions, ): datatypes.MessageId[] {
        function getMessageIds(this: ITriggerFunctions, itemSubscribeToMessageDeletedNotification: IDataObject): datatypes.MessageId {
            const itemMessageIds = itemSubscribeToMessageDeletedNotification['messageIds'] as IDataObject;
...
// message.mockData
	...
	const callback = (notification: notifications.MessageDeletedNotification) => {
	...
	return client.stubs.messageNotificationStub.messageDeleted({count, messageIds, filter}, callback, () => {});
