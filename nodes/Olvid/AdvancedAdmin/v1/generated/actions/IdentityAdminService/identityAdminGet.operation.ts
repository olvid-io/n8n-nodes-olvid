...
export const identityAdminGetProperties = updateDisplayOptions(displayOptions, properties);

export async function identityAdminGet(this: IExecuteFunctions, index: number, client: OlvidAdminClient): Promise<INodeExecutionData[]> {
