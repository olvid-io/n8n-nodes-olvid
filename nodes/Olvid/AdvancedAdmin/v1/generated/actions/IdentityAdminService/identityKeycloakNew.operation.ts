...
export const identityKeycloakNewProperties = updateDisplayOptions(displayOptions, properties);

export async function identityKeycloakNew(this: IExecuteFunctions, index: number, client: OlvidAdminClient): Promise<INodeExecutionData[]> {
