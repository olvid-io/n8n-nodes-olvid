...
export const identityNewProperties = updateDisplayOptions(displayOptions, properties);

export async function identityNew(this: IExecuteFunctions, index: number, client: OlvidAdminClient): Promise<INodeExecutionData[]> {
