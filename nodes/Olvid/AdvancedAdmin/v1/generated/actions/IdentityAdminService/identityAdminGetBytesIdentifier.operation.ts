...
export const identityAdminGetBytesIdentifierProperties = updateDisplayOptions(displayOptions, properties);

export async function identityAdminGetBytesIdentifier(this: IExecuteFunctions, index: number, client: OlvidAdminClient): Promise<INodeExecutionData[]> {
