...
const parameters: INodeProperties[] = [
	{
		...
		default: {},
		description:
			'Advanced filters to specify which messages should trigger the workflow',
		options: [
			{
			...
			},
			{
				...
				description:
					'Filter messages from a specific discussion ID (0 = any discussion)',
			},
			{
				...
				options: [
					{
						name: 'Any',
						value: datatypes.MessageFilter_Attachment.UNSPECIFIED.valueOf(),
					},
					{
						name: 'Has attachments',
						value: datatypes.MessageFilter_Attachment.HAVE.valueOf(),
					},
					{
						name: 'No attachments',
						value: datatypes.MessageFilter_Attachment.HAVE_NOT.valueOf(),
					},
				],
			...
			},
			{
				...
				options: [
					{
						name: 'Any',
						value: datatypes.MessageFilter_Location.UNSPECIFIED.valueOf(),
					},
					{
						name: 'Has location',
						value: datatypes.MessageFilter_Location.HAVE.valueOf(),
					},
					{
						name: 'Is location send',
						value: datatypes.MessageFilter_Location.IS_SEND.valueOf(),
					},
					{
						name: 'Is sharing location',
						value: datatypes.MessageFilter_Location.IS_SHARING.valueOf(),
					},
					{
						name: 'Location sharing finished',
						value:
							datatypes.MessageFilter_Location.IS_SHARING_FINISHED.valueOf(),
					},
					{
						name: 'No location',
						value: datatypes.MessageFilter_Location.HAVE_NOT.valueOf(),
					},
				],
...
export const messageReceivedParameters = updateDisplayOptions(
	displayOptions,
	parameters,
);
