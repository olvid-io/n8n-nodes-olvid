...
export function reactionAdded(
	...
	// Build filters from trigger parameters
	const filter = buildMessageFilter(this) || buildLegacyMessageFilter(this);
	const reactionFilter = buildReactionFilter(this);
