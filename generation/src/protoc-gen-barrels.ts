...
/*
** barrels are files that import exported elements from other files to create "submodules"
* for example we create a datatypes.ts file that will import everything from files next to it
* and allows us to import datatypes module in olvid.ts root file
 */
function generateBarrels(schema: Schema) {
